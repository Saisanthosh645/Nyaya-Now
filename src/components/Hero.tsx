      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 max-w-md mx-auto mb-6">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 sm:px-7 py-3.5 rounded-xl bg-slate-800 hover:bg-slate-700/80 active:bg-slate-700 text-slate-100 font-bold text-base border border-slate-700 hover:border-slate-600 transition-all cursor-pointer"
          >
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-xl mx-auto mt-10 pt-8 border-t border-slate-800/80 text-left">
          <div className="flex items-center space-x-2 text-xs text-slate-300">
            <Zap className="w-4 h-4 text-amber-400 shrink-0" />
            <span className="font-semibold leading-tight">30-Second Guides</span>
          </div>
          <div className="flex items-center space-x-2 text-xs text-slate-300">
